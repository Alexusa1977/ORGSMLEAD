...
const Sidebar: React.FC<SidebarProps> = ({ files, activeFileId, onSelectFile, onCreateClick, onDeleteFile }) => {
  return (
          ...
          {files.map(file => (
            ...
            >
              ...
              <button 
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 p-1 hover:bg-red-50 hover:text-red-600 rounded-md transition-all text-slate-400"
              >
