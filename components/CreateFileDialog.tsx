      ...
      <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Keywords (Comma separated)</label>
              <textarea 
                placeholder="best realtor, buy house Miami, selling my home..."
                required
                rows={3}
              ...
              ></textarea>
              <p className="text-[10px] text-slate-400 mt-2 font-medium">Pro-tip: Use "looking for [keyword]" phrases for better results.</p>
            </div>
          </div>
