      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
            ...
            {discoveredGroups.length > 0 && (
              <div className="mt-8 pt-8 border-t border-slate-100">
                <div className="flex items-center justify-between mb-4">
                   ...
                   <span className="text-[10px] font-bold text-slate-400 uppercase">{discoveredGroups.length} Groups Selected</span>
                </div>
        ...
        <div className="lg:col-span-4">
          <div className="bg-white border border-slate-200 rounded-3xl p-8 sticky top-8">
            <h4 className="font-bold text-slate-800 mb-6">Technical Guidance</h4>
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-700 mb-1">Public vs Private</p>
                  <p className="text-[10px] text-slate-500 leading-relaxed">This tool scans the **indexed web**. If a Facebook group is set to 'Private', its comments are invisible to search engines. For private content, manual links are recommended.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-700 mb-1">Relevance Filtering</p>
                  <p className="text-[10px] text-slate-500 leading-relaxed">LeadSync uses AI to filter out "junk" posts (like ads or spam) and only shows you people actively asking for help.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-slate-200 pt-12">
        ...
        {leads.length > 0 ? (
          ...
          <div className="bg-white border border-dashed border-slate-200 rounded-[3rem] p-32 text-center">
             ...
             <p className="text-[10px] text-slate-300 max-w-xs mx-auto">Try adding more specific keywords or broaden your target location to capture more indexed web activity.</p>
          </div>
        )}
      </div>
    </div>
